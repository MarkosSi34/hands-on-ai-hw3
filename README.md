...
CUDA_VISIBLE_DEVICES="" python cpu_benchmark.py   # → results/cpu_benchmark.png (CPU/Σενάριο 1)
```
...
| Precision | Size (MB) | Tokens/sec | Perplexity |
|-----------|-----------|------------|------------|
| FP32 | 5888.8 | 40.2 | 15.689 |
| BF16 | 2944.4 | 41.6 | 15.679 |
| INT8 | 1694.9 | 9.1 | 15.821 |
| INT4 | 1070.2 | 28.9 | 17.827 |
...
| Precision | Size (MB) | Tokens/sec | Perplexity |
|-----------|-----------|------------|------------|
| FP32 | 4714.3 | 45.3 | 25.548 |
| BF16 | 2357.1 | 50.3 | 25.573 |
| INT8 | 1429.1 | 14.1 | 25.959 |
| INT4 | 965.1 | 36.2 | 27.900 |
